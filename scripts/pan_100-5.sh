python train_continual.py --dist-url auto --num-gpus 2 --config-file configs/ade20k/panoptic-segmentation/100-5.yaml \
...
#   python train_continual.py --num-gpus 2 --config-file configs/ade20k/panoptic-segmentation/100-5.yaml \
