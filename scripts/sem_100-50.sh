...
CONT.TASK 2 SOLVER.BASE_LR 0.0 SOLVER.MAX_ITER 1900 CONT.COLLECT_QUERY_MODE True OUTPUT_DIR output/ss/100-50_bbox/step2 \

python train_continual.py --num-gpus 4 --resume --config-file configs/ade20k/semantic-segmentation/100-50.yaml \
CONT.TASK 2 SOLVER.BASE_LR 0.00005 SOLVER.MAX_ITER 50000 CONT.LIB_SIZE 80 CONT.COLLECT_QUERY_MODE False OUTPUT_DIR output/ss/100-50_bbox/step2 \
