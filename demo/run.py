...
ids = [108, 84, 48, 141, 129, 92, 46, 112,  54, 144,  55,  51,  40, 114,  60, 106, 131, 109, 113, 143]
...
output = '/public/home/zhuyuchen530/projects/cvpr24/2sM2F/demo'
...
for i in ids[::-1]:
    ...
    for img in image_list[i]:
        ...
        if os.path.exists(gt):
            ...
            subprocess.run(f'cp {gt} /public/home/zhuyuchen530/projects/cvpr24/2sM2F/demo/{name}/{gt_img_name} ', shell=True)
        else:
